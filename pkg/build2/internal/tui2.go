...
func (g *eventDrivenGroup) Description(format string, args ...interface{}) {
...
func (g *eventDrivenGroup) Subgroup(name string) LogGroup {
	newGroup := &eventDrivenGroup{
		groupStream: g.groupStream,
		lastUpdate:  time.Now(),
		id:          uuid.NewString(),
...
func (l *eventDrivenLogger) Group(name string) LogGroup {
	newGroup := &eventDrivenGroup{
