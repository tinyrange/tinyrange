...
func fromProtoDirective(db *hash.DefinitionDatabase, d *pb.Directive) (common.Directive, error) {
    ...
    case *pb.Directive_AddFile:
        ...
        if v.AddFile.GetDefinition() != nil {
            ...
            if !ok { return nil, fmt.Errorf("hash %s is not BuildDefinition", v.AddFile.GetDefinition().GetHash()) }
        }
    ...
    case *pb.Directive_Archive:
        ...
        if v.Archive.GetDefinition() != nil {
            ...
            var ok bool
            def, ok = d2.(common.BuildDefinition)
            if !ok { return nil, fmt.Errorf("hash %s is not BuildDefinition", v.Archive.GetDefinition().GetHash()) }
        }
    ...
    case *pb.Directive_Kernel:
        ...
        if v.Kernel.GetKernel() != nil {
            ...
            if !ok { return nil, fmt.Errorf("hash %s is not BuildDefinition", v.Kernel.GetKernel().GetHash()) }
        }
        if v.Kernel.GetInitramfs() != nil {
            ...
            if !ok { return nil, fmt.Errorf("hash %s is not BuildDefinition", v.Kernel.GetInitramfs().GetHash()) }
        }
...
func init() {
    ...
    hash.RegisterProto(&buildVmDefinition{}, (*pb.BuildVmParameters)(nil), func(db *hash.DefinitionDatabase, msg any) (hash.SerializableValue, error) {
        ...
        if p.GetKernel() != nil {
            ...
            if !ok { return nil, fmt.Errorf("kernel ref %s is not BuildDefinition", p.GetKernel().GetHash()) }
        }
        if p.GetInitRamFs() != nil {
            ...
            if !ok { return nil, fmt.Errorf("initramfs ref %s is not BuildDefinition", p.GetInitRamFs().GetHash()) }
        }
    ...
    hash.RegisterProto(&decompressFileBuildDefinition{}, (*pb.DecompressFileParameters)(nil), func(db *hash.DefinitionDatabase, msg any) (hash.SerializableValue, error) {
        ...
        if p.GetBase() != nil {
            ...
            if !ok { return nil, fmt.Errorf("base ref %s is not BuildDefinition", p.GetBase().GetHash()) }
        }
