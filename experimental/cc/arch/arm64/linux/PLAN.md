...
**Test Cases:**
- [ ] Allocate host memory for guest RAM
- [ ] Map guest physical address ranges to host virtual memory
- [ ] Test different memory sizes (1MB, 16MB, 64MB, 128MB)
- [ ] Test memory read/write operations from vCPU
- [ ] Execute a simple instruction sequence (e.g., infinite loop)
- [ ] Verify vCPU enters and exits correctly

## Phase 2: Basic Execution Environment

### Milestone 2.1: Simple Payload Execution
**Test Cases:**
- [ ] Load and execute hand-crafted ARM64 assembly that writes to memory
- [ ] Execute payload that performs arithmetic operations
- [ ] Test branching and basic control flow
- [ ] Verify register state preservation across VM exits

### Milestone 2.2: Exception and VM Exit Handling
**Test Cases:**
- [ ] Handle data abort exceptions (invalid memory access)
- [ ] Handle instruction abort exceptions
- [ ] Process hypercalls/HVC instructions
- [ ] Test undefined instruction handling
- [ ] Implement basic exit reason dispatching

### Milestone 2.3: Interrupt Controller Foundation
**Test Cases:**
