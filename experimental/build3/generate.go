...
func graphToBuildDefinition(graph []Edge) (map[int]common.BuildDefinition, error) {
	defs := make(map[int]common.BuildDefinition)
...
func loadGraph(in io.Reader) (common.BuildDefinition, error) {
