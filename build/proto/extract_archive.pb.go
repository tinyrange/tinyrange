...
type ExtractArchiveDefinition struct {
	...
	//
	//	*ExtractArchiveDefinition_FetchHttp
	Source          isExtractArchiveDefinition_Source `protobuf_oneof:"source"`
...
func (x *ExtractArchiveDefinition) GetSource() isExtractArchiveDefinition_Source {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *ExtractArchiveDefinition) GetFetchHttp() *FetchHttpDefinition {
	if x != nil {
		if x, ok := x.Source.(*ExtractArchiveDefinition_FetchHttp); ok {
			return x.FetchHttp
		}
	}
	return nil
...
type isExtractArchiveDefinition_Source interface {
	isExtractArchiveDefinition_Source()
}

type ExtractArchiveDefinition_FetchHttp struct {
	FetchHttp *FetchHttpDefinition `protobuf:"bytes,1,opt,name=fetch_http,json=fetchHttp,proto3,oneof"`
}

func (*ExtractArchiveDefinition_FetchHttp) isExtractArchiveDefinition_Source() {}

var File_extract_archive_proto protoreflect.FileDescriptor

const file_extract_archive_proto_rawDesc = "" +
	"\n" +
	"\x15extract_archive.proto\x12\x05proto\x1a\x10fetch_http.proto\"\xdb\x01\n" +
	"\x18ExtractArchiveDefinition\x12;\n" +
	"\n" +
	"fetch_http\x18\x01 \x01(\v2\x1a.proto.FetchHttpDefinitionH\x00R\tfetchHttp\x125\n" +
	"\farchive_type\x18\x02 \x01(\x0e2\x12.proto.ArchiveTypeR\varchiveType\x12A\n" +
	"\x10compression_type\x18\x03 \x01(\x0e2\x16.proto.CompressionTypeR\x0fcompressionTypeB\b\n" +
	"\x06source*4\n" +
...
var file_extract_archive_proto_goTypes = []any{
	...
	(*FetchHttpDefinition)(nil),      // 3: proto.FetchHttpDefinition
}
var file_extract_archive_proto_depIdxs = []int32{
	3, // 0: proto.ExtractArchiveDefinition.fetch_http:type_name -> proto.FetchHttpDefinition
...
func file_extract_archive_proto_init() {
	...
	file_extract_archive_proto_msgTypes[0].OneofWrappers = []any{
		(*ExtractArchiveDefinition_FetchHttp)(nil),
	}
	type x struct{}
